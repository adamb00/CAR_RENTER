...
export default function Explore() {
  ...
  return (
    <div className='min-h-max h-full bg-linear-to-br from-(--sky-dark)/70 to-(--amber-light)/70 -skew-y-10 md:-skew-y-6 flex-col flex items-center gap-10 justify-center p-2 md:p-10 py-20 md:py-40 my-40'>
      ...
      <div className='skew-y-10 md:skew-y-6 grid grid-cols-1 lg:grid-cols-3 gap-10 p-3'>
        <div className='bg-grey-light-1/80 rounded-lg max-w-120 min-h-80 lg:min-h-120 flex flex-col justify-center items-center'>
          <i className='icon-basic-map text-[4rem] inline-block bg-clip-text text-transparent bg-linear-to-br from-(--sky-dark)/70 to-(--amber-light)/70'></i>
