...
const IMAGE_BASE =
  'https://waximdqzopehmgjcpudg.supabase.co/storage/v1/object/public/images/blog_3';
...
> = {
  'el-cotillo': [
    {
      src: `${IMAGE_BASE}/Coraleo 2.jpg`,
      alt: 'Calm lagoon waters along the coast of Fuerteventura',
    },
  ],
  'sotavento-costa-calma': [
    {
      src: `${IMAGE_BASE}/Coraleo 3.jpg`,
      alt: 'Shallow tidal lagoons near Sotavento in Fuerteventura',
    },
  ],
  cofete: [
    {
      src: `${IMAGE_BASE}/Coraleo 4.jpg`,
      alt: 'Wild Atlantic coastline and open beach in Fuerteventura',
    },
  ],
  'route-plan': [
    {
      src: `${IMAGE_BASE}/Coraleo 6.jpg`,
      alt: 'Coastal road and seaside views on Fuerteventura',
    },
  ],
};

export default function Post_3({ locale, slug, post }: BlogPostComponentProps) {
