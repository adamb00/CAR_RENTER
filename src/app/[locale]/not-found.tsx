...
export default function NotFound() {
  ...
  return (
    <main className='min-h-screen bg-linear-to-br from-sky-dark/80 via-amber-dark/70 to-sky-dark/80 text-slate-100 flex items-center justify-center px-4 py-16'>
      <div className='w-full max-w-6xl rounded-3xl bg-white/10 backdrop-blur-md shadow-2xl ring-1 ring-white/10 overflow-hidden'>
        <div className='grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center'>
          <section className='px-8 py-12 lg:px-14 lg:py-16 flex flex-col gap-6'>
            ...
            <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold uppercase leading-tight tracking-widest text-white'>
              {t('title')}
            </h1>
          ...
          <section className='relative h-full min-h-72 lg:min-h-96 bg-linear-to-br from-white/15 via-transparent to-white/5 flex items-center justify-center'>
            <div className='absolute inset-6 rounded-4xl border border-white/15 bg-white/5' />
